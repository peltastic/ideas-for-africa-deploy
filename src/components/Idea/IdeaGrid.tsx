  ...
  return (
    <>
      ...
      <div className="w-full">
        ...
        {modified ? null : (
          <div className="flex items-center flex-wrap sm:flex-nowrap my-6 gap-4">
            {/* <HoverCardComponent
                fit
                textSize="xs"
            ...
            >
              <button className="flex items-center justify-center text-xs w-[15rem]  sm:w-[10rem] rounded-md sm:rounded-full px-4 py-3  bg-primary text-white  border-primary border">
                <Image
                  src={BrainstormSvg}
                  className="mr-2"
                  alt="brainstorm svg"
            ...
            <div className="hidden lg:block">
              ...
              >
                <button
                  ...
                  className="flex items-center text-xs rounded-full px-4 py-3 w-[15rem] sm:w-[10rem] justify-center bg-primary text-white border-primary border"
                >
                  <Image
                    src={ModifyIdeaImg}
                    className="mr-2"
