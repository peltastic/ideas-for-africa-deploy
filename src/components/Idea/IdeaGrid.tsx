      ...
      <div className="w-full">
        ...
        {modified ? null : (
          <div className="flex items-center flex-wrap xxs:flex-nowrap my-6 gap-4">
            ...
            >
              <button className="flex items-center justify-center text-xs w-[15rem] xs:w-auto sm:w-[10rem] rounded-md sm:rounded-full px-4 py-3 xs:py-2 sm:py-3  bg-primary text-white  border-primary border">
                <Image
                  src={BrainstormSvg}
                  className="mr-2"
                  alt="brainstorm svg"
            ...
            <div className="block lg:hidden">
              <button
                ...
                className="flex items-center text-xs rounded-md sm:rounded-full px-4 py-3 xs:py-2 sm:py-3 w-[15rem] xs:w-[10rem] justify-center bg-primary text-white border-primary border"
              >
                <Image
                  src={ModifyIdeaImg}
                  className="mr-2"
