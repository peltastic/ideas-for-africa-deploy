...
const InnovativeIdeasCard = (props: Props) => {
  return (
    <div className=" relative h-[29rem] py-4 mb-6 px-4 shadow-[0_0px_10px_rgba(0,0,0,0.1)] w-full rounded-xl">
      <div className="">
        <div className="relative">
          ...
          />
          <p className="bg-white absolute left-4 bottom-4 py-1 px-2 rounded-full text-[.7rem] font-semibold text-black">{props.data.category}</p>
        </div>
        ...
        <div className="w-full">
          ...
          <div className="absolute bottom-4 flex mt-6 items-center">
            <div className="mr-4">
