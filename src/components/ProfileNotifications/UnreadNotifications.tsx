...
import { useLazyGetUserUnreadNotificationQuery } from "@/lib/features/notifications";
...
const UnreadNotifications = ({ type }: Props) => {
  const id = getCookie("id");
  const [getUnread, { data, isFetching, isError, isSuccess }] =
