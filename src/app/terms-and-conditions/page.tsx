  ...
  return (
    <div className="">
      ...
      <div className="px-8 mt-10">
        ...
        <h2 className="mt-4 font-semibold text-lg mb-4">Welcome to IdeasAfrica.org!</h2>
        <p className="mb-4">
          IdeasAfrica.org is a platform designed to foster open and
          collaborative
        </p>

        <h3 className="font-semibold text-lg mb-2">1. Sharing Your Ideas:</h3>
        <p className="mb-4">
        ...
        <ul className="list-disc px-[3rem] mb-4">
          <li>
          ...
          <li>Spams or solicits users.</li>
        </ul>
        <h3 className="font-semibold text-lg mb-2">4. Disclaimer:</h3>
        <p className="mb-4">
        ...
        <h3 className="font-semibold text-lg mb-2">5. Limitations of Liability:</h3>
        <p className="mb-4">
        ...
        <h3 className="font-semibold text-lg mb-2">8. Entire Agreement:</h3>
        <p className="mb-2">
