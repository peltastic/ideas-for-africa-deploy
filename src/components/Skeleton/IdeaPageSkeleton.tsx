...
const IdeaPageSkeleton = (props: Props) => {
  return (
    <div>
      <div className="bg-gray2 w-full h-[1.3rem] mr-6 animate-pulse "></div>
      <div className="bg-gray2 w-[30%] mt-2 h-[1.3rem] mr-6 animate-pulse "></div>
      <div className="bg-gray2 w-[5rem] mt-6 h-[1.3rem] mr-6 animate-pulse "></div>
      ...
      <div className="mt-14">
        <div className="bg-gray2 w-full h-[0.9rem] mb-2 mr-6 animate-pulse "></div>
        <div className="bg-gray2 w-full h-[0.9rem] mb-2 mr-6 animate-pulse "></div>
        <div className="bg-gray2 w-[60%] h-[0.9rem] mb-2 mr-6 animate-pulse "></div>
        <div className="bg-gray2 w-full h-[0.9rem] mb-2 mr-6 animate-pulse "></div>
        <div className="bg-gray2 w-[30%] h-[0.9rem] mb-2 mr-6 animate-pulse "></div>
      </div>
